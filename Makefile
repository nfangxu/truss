...
gobindata:
	go generate github.com/nfangxu/truss/gengokit/template

# Install truss
truss: gobindata
	go install -ldflags '-X "main.version=$(SHA)" -X "main.date=$(VERSION_DATE)"' github.com/nfangxu/truss/cmd/truss
