...
import (
	...
	helper "github.com/nfangxu/truss/gengokit/gentesthelper"
...
func TestApplyServerTempl(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/nfangxu/truss/gengokit/general-service",
	...
	expected := `
		...
		import (
			...
			pb "github.com/nfangxu/truss/gengokit/general-service"
		)
