...
import (
	...
	"github.com/nfangxu/truss/gengokit"
	templateFileAssets "github.com/nfangxu/truss/gengokit/template"
	"github.com/nfangxu/truss/svcdef"

	"github.com/nfangxu/truss/gengokit/gentesthelper"
)
...
func TestApplyTemplateFromPath(t *testing.T) {
	const def = `
		...
		import "github.com/nfangxu/truss/deftree/googlethirdparty/annotations.proto";
	...
	conf := gengokit.Config{
		GoPackage: "github.com/nfangxu/truss",
		PBPackage: "github.com/nfangxu/truss/gengokit/general-service",
	}
...
func TestAllTemplates(t *testing.T) {
	const goPackage = "github.com/nfangxu/truss/gengokit"
	const goPBPackage = "github.com/nfangxu/truss/gengokit/general-service"
	...
	conf := gengokit.Config{
		GoPackage: "github.com/nfangxu/truss/gengokit",
		PBPackage: "github.com/nfangxu/truss/gengokit/general-service",
	}
